<script type="text/javascript">var scenarioSavedId =  <?= $scenario['Scenario']['id']; ?>  ;</script>
...
<?php if($forMaping) {
	...
	//get scenario to strig var
	$scenarioForReplace = (String) $scenario['Scenario']['scenario'];

	//decode match
	$ma_decoded = json_decode( $mapping['Mapping']['mapping'] );
	
	//recorre match
	foreach ( $ma_decoded  as $value) {

		//check if value in not 'Unmatched'
		if($value['0'] != 'Unmatched') {
			//repalce matches
			$scenarioForReplace = str_replace($value['0'], $value['1'], $scenarioForReplace);		
		}
	} ?>

	<script type="text/javascript">var run_scenario =  <?= $scenarioForReplace; ?>  ;</script>

<?php } else { ?>
	
	<script type="text/javascript">var run_scenario =  <?= $scenario['Scenario']['scenario']; ?>  ;</script>
...
<section>
	<div class="container">
		<div class="row header-new-scenario">
			...
			<h3 class="subtitle-newscenario">Run: <span id="name-scenario-edit"> <?php echo $scenario['Scenario']['name']; ?> </span> </h3>
			<?php echo $this->Html->link('Back to dashboard', array('controller' => 'User', 'action' => 'dashboard/?tab='.$scenario['Scenario']['provider']), array('class'=>'btn btn-primary btn-xs back-to-dashboard')); ?>
		</div>
		...
		<?php if (!empty($columnInfo)) { ?>
			<div class="row">
				...
				<?php echo $this->Form->create(null, $options = array('url'=> array('controller'=>'User', 'action'=>'saveScenario'), 'id'=>'runScenarioForm', 'class'=>"form-horizontal" )); ?>			

					<!--ID dataset-->
					<?php echo $this->Form->input('datasetId', $options = array('type'=>'hidden', 'value'=>$dataset_id, 'name' => 'datasetId', 'id' => 'datasetId' )); ?>

					<?php echo $this->Form->input('dataset', $options = array('type'=>'hidden', 'value'=>$dataset_id, 'name' => 'dataset', 'id' => 'dataset' )); ?>
					
					<?php echo $this->Form->input('provider', $options = array('type'=>'hidden', 'value'=>strstr($dataset_id, '_', true), 'name' => 'provider', 'id' => 'provider' )); ?>

					<!--scenario name-->
					<?php echo $this->Form->input('scenario_name', $options = array('type'=>'hidden', 'value'=>$scenario['Scenario']['name'], 'name' => 'scenario_name', 'id' => 'scenario_name' )); ?>	
					
					<?php echo $this->Form->input('scenario_val', $options = array('type'=>'hidden', 'name' => 'scenario_val', 'id' => 'scenario_val')); ?>

					<!--ID scenario-->
					<?php echo $this->Form->input('scenario_id', $options = array('type'=>'hidden', 'value'=>$scenario['Scenario']['id'], 'name' => 'scenario_id', 'id' => 'scenario_id' )); ?>	

					<!-- Nav tabs -->
					<ul class="nav nav-tabs" role="tablist" id="ul-tabs-providers">
						<li role="presentation" class="active">
							<a href="#screening" aria-controls="screening" role="tab" data-toggle="tab">Filter</a>
						</li>
						<li role="presentation" >
							<a href="#weighting" aria-controls="weighting" role="tab" data-toggle="tab">Weighting</a>
						</li>
						<li role="presentation">
							<a href="#result" aria-controls="result" role="tab" id="link-tab-results" _class="animated rubberBand" data-toggle="tab">Results</a>
						</li>

						<div style="float: right">
							<?php echo $this->Form->button('<span>Save</span> ', $options = array('type'=>'button', 'class'=>"btn btn-success", 'id'=>'saveButton', 'disabled'=>'disabled')); ?>&nbsp;
						</div>

						<div style="float: right">
							<?php echo $this->Form->button('<span>Save As</span> ', $options = array('type'=>'button', 'class'=>"btn btn-success", 'id'=>'saveAsButton', 'disabled'=>'disabled')); ?>&nbsp;
						</div>
<!--
						Original Save Functionality
						<div style="float: right">
							<?php echo $this->Form->button('<span>Save</span>', $options = array('id'=>'save-button','type'=>'button', 'class'=>"btn btn-success", 'onclick'=>'saveResultsNew()')); ?>&nbsp;
						</div>
-->
					...
					<div class="tab-content">
								...
								<div class="col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-xs-offset-0 col-lg-10 col-md-10 col-sm-10 col-xs-12">
									...
									<div class="form-group">
									    <div class="col-lg-11 text-right">
											...
											<?php echo $this->Form->button('<span>Run Scenario</span>', $options = array('type'=>'submit', 'class'=>"btn btn-primary", 'id'=>'btnSubmitScenario', )); ?>
									    </div>
									</div>
														      ...
														      <?php 
																...
																echo $this->Form->input(
																	...
																	$options = array(
																		...
																		'type'=>"number", 
																		'step'=>"any", 
																		'class'=>'  narrow form-control new-scenario-weight', 
																		'min'=>'0', 
																		'value'=>'0', 
												...
												<div class="row">
													...
													<div class="row">
														<div class="col-lg-offset-0 col-md-offset-0 col-sm-offset-0 col-xs-offset-0 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
															<!--check for group-->
															<?php echo $this->Form->input($group, $options = array('name' => 'weighting_group_check__' . $group, 'id' => 'weighting_group_check__' . $group,  'type' => 'checkbox', 'div'=>false, 'value'=> $group, 'onclick'=>'showHideWeightGroup( this, "'. $group .'" );', 'class'=>'check-group-runScenario')); ?>
																	      ...
																	      <?php 
																			echo $this->Form->input(
																				...
																				$options = array(
																					...
																					'type'=>"number", 
																					'step'=>"any", 
																					'class'=>'form-control narrow new-scenario-weight-group new-scenario-weight-group-' . $group, 
																					'min'=>'0',
																					'value'=>'0',
						...
						<div role="tabpanel" class="tab-pane-newScenario tab-pane" id="result">
							...
							<div class="row content-button-save-top">
