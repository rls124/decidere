<script type="text/javascript">var scenario_saved =  <?= $scenario['Scenario']['scenario'] ?>  ;</script>
...
<script type="text/javascript">var periodFavorite =  <?php echo json_encode( $scenario['Scenario']['dataset'] );  ?>;</script>
...
<section>
	<div class="container">
		<div class="row header-new-scenario">
			<h3 class="subtitle-newscenario">Edit: <span id="name-scenario-edit"> <?php echo $scenario['Scenario']['name']; ?> </span> </h3>
		...
		<?php if (!empty($columnInfo)) { ?>
			<div class="row">
				...
				<?php echo $this->Form->create(null, $options = array('url'=> array('controller'=>'User', 'action'=>'editScenario'), 'id'=>'editScenarioForm', 'class'=>"form-horizontal" )); ?>			
					...
					<ul class="nav nav-tabs" role="tablist" id="ul-tabs-providers">
						...
						<li role="presentation">
							<a href="#result" id="link-tab-results" aria-controls="result" role="tab"  data-toggle="tab">Results</a>
						</li>
...
/*
										*** DEBUG PURPOSES ONLY ***	
										if ($input->Column == "Alternative_Investments") {
											$input->Column="TEST4";
										}

										if ($input->Column == "Enrollment_Minimum__") {
											$input->RangeStart = 0;
											$input->RangeEnd = 600000;
										}
*/
										//print_r(array("<pre>",$input,"</pre>"));'									
										?>	
