		...
		<div class="container">
			...
			<div class="row content-title-shopping-cart">
				...
				<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12 f-right">
					<?php echo $this->Html->link( $this->Html->image( 'checkout.png', $options = array()) , array('controller' => 'Shop', 'action' => 'index'), array('escape'=>false)); ?>
				</div>
			</div>
			<div class="row">
				...
				<div>
				  ...
				  <ul class="nav nav-tabs tabs-categories" role="tablist">
					  <!-- Nav tabs -->
				  ...
				  <div class="tab-content">
					...
					<?php foreach ($categories as $key => $value) { ?>
						...
						<div role="tabpanel" class="tab-pane animated fadeIn  <?php if( $key == 0 ){ echo 'active'; }  ?> " id="<?php echo str_replace( $search_replace, '_', $value['Category']['name'] ) ?>">
										...
										foreach ($provider['Plan'] as $key => $plan) { ?>
												...
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<div class="row item-dataset">
														<p class="item-dataset-premium"> <?php echo $provider['name'] ?> 
														<?php if (in_array($plan['id'], $user_plans)){  ?>
														...
														<div class="col-50 f-right">
															...
															<?php if( in_array($plan['id'], $user_plans ) or $plan['type'] == '1'  ) { 
