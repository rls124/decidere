<div class="row">
	<div class="row">
		...
		<div class="row">
			...
			<?php echo $this->Form->input('history', $options = array('class'=>'froala-editor-large', 'label'=>'Descripción de la empresa: ', 'required'=>'required', 'value'=>$companyData['CompanyDatum']['history'])); ?>
			
			<?php echo $this->Form->input('contact', $options = array('type'=>'hidden', 'value'=>$companyData['CompanyDatum']['contact'])); ?>
